...
@Component
public class TeacherExamService extends ExamService implements ITeacherExamService {

    protected TeacherExamService(PagingAndSortingRepository<ExamEntity, UUID> repository, @Qualifier("questionBankService") IQuestionBankService iQuestionBankService, IExamQuestionService iExamQuestionService) {
