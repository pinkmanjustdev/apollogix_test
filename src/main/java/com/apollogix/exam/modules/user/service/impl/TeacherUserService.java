...
public class TeacherUserService extends UserService implements ITeacherUserService {
    protected TeacherUserService(PagingAndSortingRepository<UserEntity, UUID> repository, UserRepository userRepository, PasswordEncoder passwordEncoder) {
